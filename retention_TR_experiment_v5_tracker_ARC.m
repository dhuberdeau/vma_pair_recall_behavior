function varargout = retention_TR_experiment_v5_tracker_ARC(varargin)
...
targ_arc_length = 60;
targ_arc_angles_start = [90 - targ_arc_length/2, 180 - targ_arc_length/2,...
    270 - targ_arc_length/2, 360 - targ_arc_length/2];
arc_width = 10;
...
%         exp_time = tic;
        ...
        for i_tr = 1:N_TRS
            ...
            screen_arc_buff = nan(4,0);
            screen_arc_angle_buff = nan(2, 0);
            screen_color_buff = nan(3, 0);
            arc_color_buff = nan(3,0);
...
%                 tim(k) = toc(exp_time);
                ...
                if k_arc_buff > 0 
                    Screen('FrameArc', win, arc_color_buff, [home_position home_position]' + target_circle_dims',...
                        screen_arc_angle_buff(1,end), screen_arc_angle_buff(2,end), arc_width, arc_width);
                end
